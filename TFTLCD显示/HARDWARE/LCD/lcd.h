...
//注意设置时STM32内部会右移一位对齐! 			    
// Bank1.sector4 从6C000000开始
// 0x000007FE为A10偏移量，7EF转2进制=111 1111 1110
// 16位数据时地址右移一位对齐 011 1111 1111 此时A10=10
// 如果16位地址+1，相当于8位地址+2 即7EF+0x02 A10：A0=100 0000 0000 此时A10=1 实现了对RS 0 和1的控制


#define LCD_BASE        ((u32)(0x6C000000 | 0x000007FE)) // RS = 0
// 将LCD_BASE地址强制转换为LCD_TypeDef结构体
// LCD_REG 地址为 0x6C00 07FE		对应A10状态为0 即RS=0
// 利用结构体地址自增 LCD_RAM 地址为 0x6C00 0800（16位+1相当于8位+2）		对应A10状态为1 即RS=1
